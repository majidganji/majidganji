...
$this->title = 'جستجو: ' . $search;
?>
<h4 class="well-c"><?= Html::encode($this->title) ?></h4>
<?php if (empty($models)): ?>
    <div class="alert warning-color-dark">پیدا نشد!</div>
<?php endif; ?>
...
<div class="panel">
    ...
    <div class="panel-footer text-muted">
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="pull-left">
                    <a href="<?= Url::to(['site/post', 'slug' => $model->slug]) ?>#comments"><span class="fa fa-comments"></span> نظرات (5)</a>
                </div>
            </div>
        </div>
    </div>
